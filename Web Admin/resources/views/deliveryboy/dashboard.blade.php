            ...
            <div class="row">
               ...
               <div class="col-12 col-md-6">
                  <p class="form-control-static">
                     ...
                     <a href="{{url('deliveryboy/changeattendace/Yes')}}"><i class="fa fa-toggle-off prefenceswitch" aria-hidden="true"></i></a>
                     @endif
                     @if($presence=="Yes"||$presence=="yes")
                     <a href="{{url('deliveryboy/changeattendace/No')}}"><i class="fa fa-toggle-on prefenceswitch" aria-hidden="true" ></i></a>
                     @endif
                  </p>
               </div>
            </div>
