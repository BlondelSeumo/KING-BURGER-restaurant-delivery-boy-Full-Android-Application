         ...
         <div class="container">
            <div class="login-content">
               <div class="login-logo">
                  <h4 class="loginh4">{{__('messages.site_name')}}<font class="loginfontcolor"> {{__('messages.delivery_boy')}}</font></h4>
               </div>
               <div class="login-form">
                  ...
                  <form action="{{url('deliveryboy/postlogin')}}" method="post">
                     ...
                     <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30">{{__('messages.login')}}</button>
                       ...
                       <a href="{{url('admin')}}" class="btn btn-success btn-flat m-b-30 m-t-30 adminbtn">{{__('messages.adminlogin')}}</a></p>
                  </form>
               </div>
            </div>
         </div>
