<select id="select_currency" class="form-control col-md-6" onchange="changecurreny(this.value)">
  <option value="{{Session::get('currency')}}" selected>{{Session::get('currency')}}</option>
