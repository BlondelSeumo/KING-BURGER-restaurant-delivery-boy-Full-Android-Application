            ...
            <div class="card-body">
               <div id="pay-invoice">
                  <div class="card-body">
                     ...
                     @endif
                     <form action="{{url('updatepassword')}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="form-group">
                           ...
                           <input type="password" id="cpwd" placeholder="{{__('messages.en_cu_pd')}}" class="form-control" name="cpwd" required="" onchange="checkcurrentpwd(this.value)">
                        </div>
                        <div class="form-group">
                           <label for="name" class=" form-control-label">
