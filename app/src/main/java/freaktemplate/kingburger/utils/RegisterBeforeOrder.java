...
public class RegisterBeforeOrder extends Dialog {
    ...
    public RegisterBeforeOrder(@NonNull final Context context, int themeResId) {
    ...
    public void setOnCompleteListener(onSuccess completeListener) {
        this.success = completeListener;
    }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jo_data.getString("success").equals("1")) {
                                ...
                                Toast.makeText(context, R.string.reg_sucess, Toast.LENGTH_SHORT).show();
